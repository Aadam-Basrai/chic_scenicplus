...
def pchic_celltype_df(SCENICPLUS_obj, 
                     cell_name_dictionary):
    '''
    helper function to create pchic count dataframes per cell type'''
    peak_matrix = SCENICPLUS_obj.countdata_pchic

    pchic_celltype_dict={}
    for cellname in cell_name_dictionary.keys():
        columns = ('oeChr','oeStart','oeEnd','baitChr','baitStart','baitEnd','oeName','baitName',*cell_name_dictionary[cellname])
